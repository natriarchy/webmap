...
export class JsonDataService {
    ...
    getPropInfo(queryType: 'LOT_BLOCK_LOT' | 'PROPLOC' | 'XY', queryValue: string | [number, number], outFields?: []): Observable<ArcGeoJSONResponse<'PropInfo'>> {
    ...
    getSearchOptions(input = '', type: 'BLOCK_LOT' | 'ADDR_STREET' | 'ADDR_LEGAL'= 'ADDR_STREET'): Observable<ArcGeoJSONResponse<'AddressPts'>> {
        ...
        return this.http.get<ArcGeoJSONResponse<'AddressPts'>>(
          `${arcBaseUrl}${arcParams}`
        );
        }
}
